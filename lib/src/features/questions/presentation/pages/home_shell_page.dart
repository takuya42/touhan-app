...
class HomeShellPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HomeShellPage> createState() =>
      _HomeShellPageState();
}

class _HomeShellPageState
    extends ConsumerState<HomeShellPage> {
  int _currentIndex = 0;
...
class _HomeDashboard extends ConsumerWidget {
  ...
  Widget build(
    ...
    final correct =
        ref.watch(correctAnswerCountProvider);

    final wrong =
        ref.watch(wrongAnswerCountProvider);
    ...
    final todayStudySec =
        ref.watch(todayStudySecondsProvider);
...
class _StudyHistoryPage
  ...
  Widget build(
    ...
    final history =
        ref.watch(studyHistoryProvider);
